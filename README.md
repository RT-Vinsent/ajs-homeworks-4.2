# РЕШЕНО `Matchers`.
## `Чистые функции` с предыдущей задачи оставил.


[![Build status](https://ci.appveyor.com/api/projects/status/ksjpbagatva6282t?svg=true)](https://ci.appveyor.com/project/RT-Vinsent/ajs-homeworks-4-2)
